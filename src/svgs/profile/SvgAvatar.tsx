  ...
  return (
    <Svg width={72} height={72} viewBox="0 0 72 72" fill="none" {...props}>
      <Path
        ...
        fill="#fff"
      />
      <Mask id="prefix__a" x={0} y={0} width={72} height={72}>
        <Path
          d="M36 72c19.882 0 36-16.118 36-36S55.882 0 36 0 0 16.118 0 36s16.118 36 36 36z"
          fill="#fff"
        />
      ...
      <G mask="url(#prefix__a)">
        <Mask id="prefix__b" x={24} y={59} width={26} height={29}>
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <Path
          ...
          fill="#1A2E35"
        />
        <Mask id="prefix__c" x={13} y={36} width={40} height={44}>
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <Path
          ...
          fill="#FF4F5B"
        />
        <Mask id="prefix__d" x={54} y={8} width={2} height={2}>
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
